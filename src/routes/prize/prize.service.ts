...
export class PrizeService {
  ...
  async processMonthPrize() {
    ...
    this.recordMonthPrize(
      ENTITY.USER.RANK_TEMPERATURE,
      top5TemperatureUserIds as string[],
    );
    this.recordMonthPrize(ENTITY.USER.RANK_STUDY, top5StudyUserIds as string[]);
  }
}
